...
<p>За да се включите в подготовката на нови текстове, $ext последвайте връзката „Подготовка на ново произведение“. В случай че нямате възможност сами да сканирате текстове, може да се присъедините към коригирането на заглавията, отбелязани ето така: $umarker (може и да няма такива). Те са достъпни и чрез връзката „{$this->viewTypes['waiting']}“.</p>
...
<p class="error">С предимство ще бъдат обработвани книгите, издадени преди повече от пет години.</p>
EOS;
	}
