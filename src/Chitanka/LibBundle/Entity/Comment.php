...
/**
* @orm:Entity(repositoryClass="Chitanka\LibBundle\Entity\CommentRepository")
* @orm:Table(name="comment",
*	uniqueConstraints={@orm:UniqueConstraint(name="user_comment_uniq", columns={"text_id", "rname", "ctexthash"})},
*	indexes={
...
class Comment
{
	...
	*/
	...
	public function setCtexthash($ctexthash) { $this->ctexthash = $ctexthash; }
	public function getCtexthash() { return $this->ctexthash; }
